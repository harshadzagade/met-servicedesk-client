...
import classes from './SubadminSingleStaffDetails.module.css';
...
const SubadminSingleStaffDetails = () => {
  ...
  useEffect(() => {
    const getStaff = async () => {
      const staff = await axios.get(`/api/staff/subadmin/staffdetails/${id.staffId}`);
...
export default SubadminSingleStaffDetails;