            ...
            <main>
                <div className={classes.reqdetails}>
                    <div className={classes.header}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" className="bi bi-arrow-left-circle-fill" viewBox="0 0 16 16" onClick={() => navigate('/report', { state: { department: location.state.department || null, staff: location.state.staff || null } })}>
