    ...
    return (
        <div>
            <div className={classes.dropup}>
                <button className={classes.dropbtn}>{props.numberOfPages} <svg xmlns="http://www.w3.org/2000/svg" width="8" height="8" fill="currentColor" className="bi bi-caret-up-fill mb-1" viewBox="0 0 16 16">
