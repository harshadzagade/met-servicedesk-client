...
import classes from './SubAdminComplaintDetails.module.css';
...
const SubAdminComplaintDetails = () => {
    ...
    useEffect(() => {
        const getStaff = async () => {
            try {
                const staff = await axios.get(`/api/staff/staffdetails/${loginId}`);
    ...
    useEffect(() => {
        const getTechnicians = async () => {
            try {
                if (staff.department) {
                    const technicians = await axios.get(`/api/staff/subadmin/subadmindepartmenttechnicians/${loginId}/${staff.department}`);
                    ...
                    <div className={`${classes.complaintdetils} row`}>
                        <div className="col-8">
                            <div className={classes.header}>
                                ...
                                {openFeedback && <FeedbackForm ticketType={'concern'} ticketId={complaintData.ticketId} department={complaintData.department} onConfirm={handleFeedback} />}
...
export default SubAdminComplaintDetails;