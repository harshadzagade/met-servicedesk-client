    ...
    <div className={classes.helpdesk}  >
      {
        ...
        <aside hidden={window.location.pathname === '/login' || window.location.pathname === '/forgotpassword' || window.location.pathname === '/passwordreset' ? true : false}>
          ...
          <div className={`${classes.sidebar}`}>
            ...
            <Link to='/report' onClick={handleReportClick} className={`${isReportActive && classes.active}`} >
            ...
            <a href="#" onClick={(e) => handleLogoutClick(e)} className={`${classes.active ? classes.rowColorActive : classes.rowColorDefault}`}  >
